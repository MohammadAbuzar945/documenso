...
- **Include QR code in certificate** - This setting controls whether the signing certificate PDF will include a QR code linking to the document. It defaults to on at the organisation level. Teams can inherit or override; it can also be set per document under **Security** in the document or envelope editor.

Document visibility, language, signature settings and include QR code in certificate can be overriden on a per document basis.
