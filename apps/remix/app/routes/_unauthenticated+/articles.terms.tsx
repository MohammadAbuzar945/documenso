  ...
  return (
    <div>
      <article className="prose dark:prose-invert max-w-none">
        ...
        <p>
          <Trans>
            The Nomia App is offered and provided subject to your acceptance of the terms and
            conditions contained herein and all other operating rules, policies (including, without
            limitation, the Nomia Privacy Policy) and procedures that may be published from time to
            time on the Nomia website and which shall be incorporated herein by reference. By
            accessing, registering for and/or using the Nomia App in any manner or form you agree to
            these Terms. If you do not agree to these Terms you must immediately refrain from and/or
            cease using the Nomia App.
          </Trans>
        </p>
        ...
        <p>
          <Trans>
            Subject to your strict compliance with these Terms, we grant to you a limited, personal,
        ...
        <p>
          <Trans>
            We do not guarantee that any content will be made available on the Nomia App. We reserve
            the right to, but do not have any obligation to, (i) remove, edit and/or modify any
            content in our sole discretion, at any time, without notice to you and for any reason
            (including, but not limited to, upon receipt of claims and/or allegations from third
            parties and/or authorities relating to such content and/or if we are concerned that you
            may have violated these Terms), and/or (ii) remove or block any content from the Nomia
            App.
          </Trans>
        </p>
        ...
        <p>
          <Trans>
            We retain the right, in our sole and absolute discretion, to deny access to and/or use of
            the Nomia App to anyone at any time and for any reason. While we will use reasonable
            efforts to keep the Nomia App accessible, the same may be unavailable from time to time.
            You understand and agree that there may be interruptions to the Nomia App and/or your use
            of / access to the same due to circumstances both within our control (e.g. routine
            maintenance) and outside of our control.
          </Trans>
        </p>
        <p>
          <Trans>
            You are solely responsible for ensuring that your access to and/or use of the Nomia App
            is in compliance with all laws, rules and regulations applicable to you.
          </Trans>
        </p>
        ...
        <p>
          <Trans>
            You can purchase a monthly or annual subscription plan to make use of the Nomia App. All
            fees due and payable by you to Nomia under these Terms must be paid in full prior to the
            commencement of your monthly or annual subscription plan and without any deduction,
        ...
        <p>
          <Trans>
            In the event that you fail to make timeous payment of any relevant monthly or annual
            Nomia App subscription amount(s), for any reason whatsoever, Nomia reserves the right to,
            without any liability to you, disable your access to all or part of the Nomia App and to
            only reactivate the same once all due charges have been paid in full.
          </Trans>
        </p>
        ...
        <p>
          <Trans>
            In the event that you cancel your Nomia App subscription in accordance with these Terms we
            shall store all the User Content created by you via the Nomia App for a maximum of 30
            (thirty) days post cancellation of your relevant subscription and give you download-access
            only to the Nomia App throughout such 30-day period in order to allow you to download
            and/or store all your User Content on third party locations of your choice. Following the
            aforesaid 30-day User Content retention period, we reserve the sole right to, without any
            liability whatsoever, delete and/or destroy all your User Content and indefinitely suspend
            your access to the Nomia App.
          </Trans>
        </p>
        ...
        <p>
          <Trans>
            You represent and warrant that: (i) you will respect the intellectual property, other
            information and all our rights as well as others using the Nomia App; and (ii) any
            information and/or User Content you provide in connection with your access to and/or use
            of the Nomia App shall not infringe on any proprietary right of any party including
            patent, trademark, trade secret, copyright, right of publicity and/or other rights.
          </Trans>
        </p>
        ...
        <p>
          <Trans>
            All content you or your users upload, create, submit, distribute, post and/or store as
            part of the Nomia App including, but not limited to, document layouts, source code,
        ...
        <p>
          <Trans>
            You agree that you will not, under any circumstances, transmit any User Content
        ...
        <ul>
          ...
          <li>
            <Trans>
              defames, harasses, abuses, threatens, or incites violence towards any individual or
              group;
            </Trans>
          </li>
          <li>
          ...
          <li>
            <Trans>
              violates the privacy of any third party or Nomia employee and/or representative.
            </Trans>
          </li>
        </ul>
        ...
        <p>
          <Trans>
            Nomia does not undertake to screen, review, edit, censor and/or otherwise filter and/or
            control User Content and/or the behavior of users of User Content and/or the Nomia App.
            Nomia may, but shall not be obliged to, review, either by manual and/or automated means,
            all User Content which is and/or may be uploaded on the Nomia App and monitor and/or
            review any areas of the Nomia App where users transmit and/or post communications or
        ...
        <p>
          <Trans>
            Nomia shall not be liable for any loss, deletion, removal and/or failure of delivery to
            the intended recipient of any User Content whether caused by computer virus, unauthorised
            access and/or otherwise. You remain personally responsible for maintaining adequate
            back-up copies of all User Content and we accept no liability for the loss, deletion,
            removal or destruction of the same for any reason whatsoever.
          </Trans>
        </p>
        ...
        <p>
          <Trans>
            You acknowledge that Nomia utilises third-party service providers to host and provide
            the Nomia App and store User Content and the protection of such User Content will be in
            accordance with that third-party's safeguards for the protection of the security,
            confidentiality and integrity of User Content. You are responsible for properly
            configuring and using the Nomia App and taking appropriate steps to maintain security,
        ...
        <p>
          <Trans>
            These Terms will remain in full force and effect for as long as you access and/or use the
            Nomia App. We may terminate your access to and/or use of all or any part of the Nomia App
            at any time, with or without notice, effective immediately and without liability, should
            you or any of your users at any time violate any of these Terms.
          </Trans>
        </p>
        ...
        <p>
          <Trans>
            Where we provide document storage facilities via the Nomia App we reserve the right to
            impose and vary limits and/or restrictions (temporary or otherwise) on the use of the
            Nomia App including, without limitation, limits on the storage provided by reference to
            storage space, time/age of files, number and/or size of files, amount of data downloaded
            and/or uploaded and/or any other criteria that Nomia may specify. Any content and/or
            materials which exceed any such limits may be deleted and/or not accepted for storage
        ...
        <p>
          <Trans>
            Unless otherwise agreed to by Nomia and you in writing, these Terms constitute the
            entire agreement between Nomia and you concerning the subject matter hereof.
          </Trans>
        </p>
        ...
        <p>
          <Trans>
            You agree that we may reference you as our customer on our website and/or marketing
            material and that we may reasonably use, on a royalty-free basis, your trademark and/or
            logo for such purpose.
          </Trans>
        </p>
        ...
        <p>
          <Trans>
            You may not assign your rights under these Terms to any other party without Nomia's
            express prior written consent. Nomia may assign its rights under these Terms to any thirds
        ...
        <p>
          <Trans>
            Except for payment obligations, neither Nomia nor you will be liable by reason of any
            failure or delay in the performance of its obligations on account of events beyond the
            reasonable control of a party, which may include denial-of-service attacks, a failure by
            a third-party hosting provider or utility provider, shortages, riots, pandemics, fires,
            acts of God, war, strikes, terrorism and/or governmental action or sanction.
          </Trans>
        </p>
        ...
        <p>
          <Trans>
            ...
            survive termination including, without limitation, licenses of User Content, ownership
            provisions, warranty disclaimers, indemnity provisions and limitations of liability.
          </Trans>
        </p>
        ...
        <p>
          <Trans>
            No waiver by Nomia of any breach and/or default and/or failure to exercise any right
            allowed under these Terms is a waiver of any preceding and/or subsequent breach and/or
            default and/or a waiver and/or forfeiture of any similar and/or future rights under these
            Terms.
          </Trans>
        </p>
